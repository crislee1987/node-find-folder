'use strict';
var FF, arrayTo_Obj, extend, fs, getFolders, glob, ifExistInRoot, isArray, isDir, isFile, isObject, isString, traversal_pattern, traverse_scope, util, _default, _filter, _filter_, _forEach, _options;
...
ifExistInRoot = function() {
  return traverse_scope.getInstance().includes(arguments[0]);
};
